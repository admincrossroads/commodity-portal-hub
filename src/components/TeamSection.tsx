    ...
    <section className="py-16 bg-gray-50" id="team">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-comm-blue mb-2">Meet Our Team</h2>
                ...
                <CarouselItem key={index} className="md:basis-1/2 lg:basis-1/3">
                  <div className="bg-white rounded-lg shadow-md overflow-hidden h-full flex flex-col">
                    ...
                    <div className="p-6 flex-grow">
                      <h4 className="text-lg font-semibold text-comm-blue">{member.name}</h4>
                      <p className="text-comm-teal font-medium mb-2">{member.role}</p>
                      <p className="text-gray-600">{member.bio}</p>
                    </div>
                    <div className="p-4 border-t border-gray-100 flex justify-center space-x-4">
                      <a href="#" className="text-gray-400 hover:text-comm-blue">
