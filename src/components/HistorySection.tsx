            ...
            <div className="flex flex-col md:flex-row items-center">
              <div className="md:w-1/2 md:pr-12 md:text-right">
                <div className="bg-white p-6 rounded-lg shadow-md border border-gray-100">
                  <h3 className="text-xl font-semibold text-comm-blue mb-2">
                    2015
                  </h3>
                  <p className="text-gray-600">
                    Ankuaru was founded with a mission to transform how
                    commodity markets operate through technology and data-driven
                    insights.
                  </p>
                </div>
              </div>
            ...
            <div className="flex flex-col md:flex-row-reverse items-center">
              <div className="md:w-1/2 md:pl-12">
                <div className="bg-white p-6 rounded-lg shadow-md border border-gray-100">
                  ...
                  <p className="text-gray-600">
                    Expanded our services to include real-time market data and
                    tender information, reaching over 5,000 users across 25
                    countries.
                  </p>
                </div>
              </div>
            ...
            <div className="flex flex-col md:flex-row items-center">
              <div className="md:w-1/2 md:pr-12 md:text-right">
                <div className="bg-white p-6 rounded-lg shadow-md border border-gray-100">
                  ...
                  <p className="text-gray-600">
                    Launched our community platform, connecting traders,
                    analysts, and industry experts to share knowledge and
                    insights.
                  </p>
                </div>
              </div>
            ...
            <div className="flex flex-col md:flex-row-reverse items-center">
              <div className="md:w-1/2 md:pl-12">
                <div className="bg-white p-6 rounded-lg shadow-md border border-gray-100">
                  ...
                  <p className="text-gray-600">
                    Reached a milestone of 10,000 users and introduced
                    AI-powered market predictions and analysis tools.
                  </p>
                </div>
              </div>
              <div className="mt-4 md:mt-0 md:w-1/2 md:pr-12 flex justify-end">
