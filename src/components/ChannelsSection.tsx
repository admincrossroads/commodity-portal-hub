      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-comm-blue">
            Access Our Platform Through Multiple Channels
          </h2>
          <div className="mt-4 h-1 w-24 bg-comm-gold mx-auto"></div>
          <p className="mt-6 text-lg text-gray-600 max-w-3xl mx-auto">
            Choose how you want to interact with our comprehensive commodity
            exchange platform through our various channels.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <Card className="shadow-lg border-t-4 border-t-comm-blue hover:shadow-xl transition-shadow duration-300">
            <CardHeader className="pb-2">
              ...
              <CardTitle className="text-2xl font-bold text-comm-blue">
                Web Platform
              </CardTitle>
            ...
            <CardContent>
              <ul className="space-y-2 text-gray-700 mb-6">
                <li className="flex items-start">
                  <svg
                    className="h-5 w-5 text-comm-teal mr-2 flex-shrink-0"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
          ...
          <Card className="shadow-lg border-t-4 border-t-comm-teal hover:shadow-xl transition-shadow duration-300">
            <CardHeader className="pb-2">
              ...
              <CardTitle className="text-2xl font-bold text-comm-teal">
                Mobile App
              </CardTitle>
              <CardDescription className="text-gray-600">
            ...
            <CardContent>
              <ul className="space-y-2 text-gray-700 mb-6">
                <li className="flex items-start">
                  <svg
                    className="h-5 w-5 text-comm-blue mr-2 flex-shrink-0"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
              ...
              <div className="flex space-x-2">
                ...
                <Button
                  className="flex-1 bg-comm-blue hover:bg-comm-blue-light "
                  onClick={() => navigate("/under-construction")}
                >
                  <svg
                    viewBox="0 0 24 24"
          ...
          <Card className="shadow-lg border-t-4 border-t-comm-gold hover:shadow-xl transition-shadow duration-300">
            <CardHeader className="pb-2">
              ...
              <CardTitle className="text-2xl font-bold text-comm-gold-dark">
                Telegram Group
              </CardTitle>
              <CardDescription className="text-gray-600">
                Get instant updates and alerts via our Telegram Group
              </CardDescription>
            </CardHeader>
            <CardContent>
              <ul className="space-y-2 text-gray-700 mb-6">
              ...
              <Button
                ...
                onClick={() =>
                  window.open("https://t.me/AnkuaruCommunity", "_blank")
                }
              >
                Join Our Telegram Group <ArrowRight className="ml-1 h-4 w-4" />
              </Button>
            </CardContent>
          </Card>
        </div>
