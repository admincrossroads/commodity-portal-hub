      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          ...
          <div className="hidden md:flex md:items-center md:space-x-6">
            ...
            <Button className="bg-comm-blue hover:bg-comm-blue-light ml-2" onClick={scrollToChannels}>Get Started</Button>
          </div>
        ...
        <div className="md:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white shadow-lg">
            ...
            <div className="px-3 py-2">
              <Button className="w-full bg-comm-blue hover:bg-comm-blue-light" onClick={scrollToChannels}>Get Started</Button>
            </div>
          </div>
        </div>
      )}
